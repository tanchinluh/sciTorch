...
# ------------------------------------------------------
# list of files
FILES_SRC = dllsciTorch.cpp gw_sciTorch.cpp libgw_sciTorch.cpp sci_int_torch_forward.cpp sci_int_torch_list.cpp sci_int_torch_load.cpp sci_int_torch_props.cpp sci_int_torch_test.cpp sci_int_torch_unload.cpp sci_int_torch_unloadall.cpp sci_sciTorch_init.cpp
# ------------------------------------------------------
# list of objects file
OBJS = dllsciTorch.obj gw_sciTorch.obj libgw_sciTorch.obj sci_int_torch_forward.obj sci_int_torch_list.obj sci_int_torch_load.obj sci_int_torch_props.obj sci_int_torch_test.obj sci_int_torch_unload.obj sci_int_torch_unloadall.obj sci_sciTorch_init.obj
OBJS_WITH_PATH = Release/dllsciTorch.obj Release/gw_sciTorch.obj Release/libgw_sciTorch.obj Release/sci_int_torch_forward.obj Release/sci_int_torch_list.obj Release/sci_int_torch_load.obj Release/sci_int_torch_props.obj Release/sci_int_torch_test.obj Release/sci_int_torch_unload.obj Release/sci_int_torch_unloadall.obj Release/sci_sciTorch_init.obj
# ------------------------------------------------------
# added libraries
FORTRAN_RUNTIME_LIBRARIES = 
OTHERLIBS = C:\PROGRA~1\SCILAB~1.2\contrib\IPCV\sci_gateway\cpp\gw_ipcv.lib
# ------------------------------------------------------
